...
function(ipGetPrefixPath pfx pth)
  ...
  set(oneValueArgs PKG DIST_DIR REPO TAG SHA256_${SYS_NAME} URL_${SYS_NAME})
...
function(xpAddCoverage)
  ...
  if(P_CSharp)
    add_custom_target(precoveragecsharp
      COMMAND dotnet tool install dotnet-reportgenerator-globaltool --version 5.1.26 --global
